...
inline std::ostream& operator <<(std::ostream &os,const Pfloat &obj)
{
...
template<> inline const char* get_type_name<tuple_of_vectors<rav1_t,short,pvad_acf0_t,short,short>>(){return "rav1_t.short.pvad_acf0_t.short.short";}
//~ DEFINE_TYPE_NAME(tuple_of_vectors<pvad_acf0_t,Pfloat>,"pvad_acf0_t.Pfloat");
template<> inline const char* get_type_name<tuple_of_vectors<pvad_acf0_t,Pfloat>>(){return "pvad_acf0_t.Pfloat";}
//~ DEFINE_TYPE_NAME(tuple_of_vectors<rvad_t,Pfloat>,"rav1_t.Pfloat");
template<> inline const char* get_type_name<tuple_of_vectors<rvad_t,Pfloat>>(){return "rav1_t.Pfloat";}
//~ DEFINE_TYPE_NAME(tuple_of_vectors<r_t,r_t,r_t,short,short,rc_t,short>,"r_t.r_t.r_t.short.short.rc_t.short");
template<> inline const char* get_type_name<tuple_of_vectors<r_t,r_t,r_t,short,short,rc_t,short>>(){return "r_t.r_t.r_t.short.short.rc_t.short";}
#endif
