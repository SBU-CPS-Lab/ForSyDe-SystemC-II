...
FORSYDE_COMPOSITE(top)
{
    ...
    SC_CTOR(top)
    {
        add_combMN(*this, "stimuli1", stimuli_func, {1,1}, {1},
            outs(src, cnt), ins(cnt_delay));
        add(new SDF::delay("src_delay1", 0))(cnt_delay, cnt);
        // add(new SDF::source("stimuli1", stimuli_func, 0.0, 20))(src);

        add_combMN(*this, "upSampler1", upSampler_func, {2}, {1},
            outs(upsrc), ins(src));
        ...
        add_combMN(*this, "downSampler1", downSampler_func, {2}, {3},
            outs(downres), ins(res));

        add_combMN(*this, "report1", report_func, {}, {1},
            outs(), ins(downres));
