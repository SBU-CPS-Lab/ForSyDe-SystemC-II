...
// SDF::sink takes the actor's behaviour as a constructor argument now,
// rather than being subclassed with a protected _func override, so this
// is a plain function handed to a sink<MergeType> in Top.hpp.
inline void Merge_func(const MergeType& inp)
    {
